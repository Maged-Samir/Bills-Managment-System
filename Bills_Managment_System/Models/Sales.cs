...
namespace Bills.Models
{
    public class Sales
    {
        //Client (ID - Total - Date - Paied - Number - percentDiscount - valueDiscount )
        ...
        //[Remote(action: "TestPaied", controller: "Sales", AdditionalFields = "TotalBill,TvalueDiscount"
        //    , ErrorMessage = "* Paied Must be less than or equal Net")]
